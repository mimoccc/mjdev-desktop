...
plugins {
    // version inherited from the root build classpath (kotlin 1.9.22);
...
group = catalog.findVersion("packageName").get().requiredVersion
version = catalog.findVersion("packageVersion").get().requiredVersion
