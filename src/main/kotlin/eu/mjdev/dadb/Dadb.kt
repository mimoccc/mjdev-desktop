...
import eu.mjdev.dadb.*
import eu.mjdev.dadb.adbserver.AdbServer
import eu.mjdev.dadb.forwarding.TcpForwardDescriptor
import eu.mjdev.dadb.forwarding.TcpForwarder
import eu.mjdev.dadb.helpers.*
import okio.*
import java.io.File
...
interface Dadb : AutoCloseable {
    ...
    companion object {
        ...
        fun create(
            ...
            socketTimeout: Int = 0
        ): Dadb = DadbImpl(host, port, keyPair, connectTimeout, socketTimeout)
