...
package org.mjdev.desktop.helpers.keyevents

import androidx.compose.ui.input.key.Key
import org.mjdev.desktop.extensions.Custom.isPrintable
    ...
    fun onEvent(event: AwtKeyEvent) {
        ...
        when {
            isKeyUp && char.isPrintable -> {
                var consumed = false
                listeners
                    .filterIsInstance<KeyEventListenerCompose>()
                    .filter { l ->
                        l.key == null
                    }.forEach { l ->
